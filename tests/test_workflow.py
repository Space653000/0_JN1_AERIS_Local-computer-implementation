...
class WorkflowTests(unittest.TestCase):
    ...
    def test_deterministic_skill_reaches_evidenced_not_verified(self):
        ...
        self.assertEqual(gates["outcomes"]["G0_CONTRACT"], "BASELINE_PASS")
        self.assertEqual(gates["outcomes"]["G1_NUMERICAL"], "BASELINE_PASS")
        self.assertFalse(gates["g0_g4_passed"])
        self.assertFalse(gates["all_g0_g5_passed"])
