(() => {
  ...
  function showError(e){document.getElementById('capOutput').textContent='未完成：'+e.message;const details=document.getElementById('capOutputDetails');if(details)details.open=true;}
