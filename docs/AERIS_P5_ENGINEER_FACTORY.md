...
(DSP x4, Speaker x3, Product x2, Microphone x3, Array x2, Failure x2) and
covers 16 of 42 skills so far (added `fractional-octave`: a pure tone
...
percentile for stratified duration splits worked out by hand; and
...
power rule, dR/dr = -4R/r); **P5.4 is not being marked done by this** -- it is
