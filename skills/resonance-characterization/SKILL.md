...
100 Hz resonance with half-power crossings at 90/110 Hz has Q=5.

Invoke with `python -m aeris_runtime.engineering.factory run-skill resonance-characterization --input PATH`. Inputs must match `input.schema.json`; unknown fields, nonfinite values and out-of-domain values are rejected.

Method: `methods/engineering/resonance-characterization.json`. Analytical, negative and repeated-run cases: `golden/engineering/Speaker/resonance-characterization`.
