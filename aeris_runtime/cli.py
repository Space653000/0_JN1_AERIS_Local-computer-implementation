...
from .ingress import public_cloud_query, download_public_url
...
def build_parser():
    ...
    i=s.add_parser("ingress",help="Download public URL to local ingress store"); i.add_argument("url"); i.add_argument("--max-bytes",type=int,default=50_000_000)
