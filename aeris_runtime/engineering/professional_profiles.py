...
_SINGLE_ROLE_DOMAIN_CONTRACTS={
    ...
    'R018':{'skill_id':'speaker-tonal-eq-baseline','method':'methods/roles/speaker-tonal-eq-baseline.json',
            'suite':'golden/roles/R018/golden.json','scope':'Supplied sampled tonal correction, spatial spread, smoothing, notch and headroom decisions; no realized filter, listening or measured acceptance.'},
    'R020':{'skill_id':'speaker-tonal-context-domain-review','method':'methods/roles/speaker-tonal-context-domain-review.json',
            'suite':'golden/roles/R020/golden.json','scope':'Independent tonal correction, spatial uncertainty and level-match assertion review; no preference, audibility or physical acceptance.'},
    'R012':{'skill_id':'speaker-signal-chain-noise-headroom-baseline','method':'methods/roles/speaker-signal-chain-noise-headroom-baseline.json',
            'suite':'golden/roles/R012/golden.json','scope':'Supplied scalar gain, uncorrelated referred-noise, loading, peak voltage/current and declared phase-margin screening; no complex-load or bench stability acceptance.'},
    'R013':{'skill_id':'speaker-signal-chain-headroom-domain-review','method':'methods/roles/speaker-signal-chain-headroom-domain-review.json',
            'suite':'golden/roles/R013/golden.json','scope':'Independent signal-chain noise, loading and peak-headroom assertion review; no rail transient, thermal, complex-load or physical stability acceptance.'},
    'R019':{'skill_id':'speaker-bass-limiter-envelope-baseline','method':'methods/roles/speaker-bass-limiter-envelope-baseline.json',
            'suite':'golden/roles/R019/golden.json','scope':'Supplied bass boost, excursion and temperature bounds, amplifier voltage, crest-factor and attack/release screening; no dynamic detector, durability or measured acceptance.'},
    'R025':{'skill_id':'speaker-bass-protection-domain-review','method':'methods/roles/speaker-bass-protection-domain-review.json',
            'suite':'golden/roles/R025/golden.json','scope':'Independent bass-excursion, thermal and limiter-envelope assertion review; no smart-amplifier observer, physical protection or lifetime acceptance.'},
    'R022':{'skill_id':'structural-acoustic-transfer-baseline','method':'methods/roles/structural-acoustic-transfer-baseline.json',
            'suite':'golden/roles/R022/golden.json','scope':'Supplied synchronized band pressure/acceleration transfer identifiability using SNR and coherence gates; no causal path, modal or radiation-efficiency acceptance.'},
    'R073':{'skill_id':'structural-acoustic-path-domain-review','method':'methods/roles/structural-acoustic-path-domain-review.json',
            'suite':'golden/roles/R073/golden.json','scope':'Independent structural/acoustic transfer, SNR and coherence assertion review; no causality, calibrated sensor or physical path acceptance.'},
    'R023':{'skill_id':'room-decay-spatial-baseline','method':'methods/roles/room-decay-spatial-baseline.json',
            'suite':'golden/roles/R023/golden.json','scope':'Supplied multi-position decay-rate fit validity, extrapolated RT60 and spatial spread screening; no diffuse-field, ray model or physical-room acceptance.'},
    'R072':{'skill_id':'room-decay-spatial-domain-review','method':'methods/roles/room-decay-spatial-domain-review.json',
