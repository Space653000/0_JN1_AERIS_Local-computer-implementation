...
def review(domain,request):
    ...
    if domain=='speaker-polar-spatial':
        from .speaker_polar_review import review as review_polar
        return review_polar(p,candidate)
    ...
    if domain=='speaker-digital-transport':
        from .speaker_digital_transport_review import review as review_transport
        return review_transport(p,candidate)
    ...
    if domain=='soundbar-crossover-wall-dialogue':
        from .av_products_review import review_soundbar
        return review_soundbar(p,candidate)
...
def _checks_coherent(skill,params,values):
    ...
    if skill=='speaker-polar-spatial-baseline':
    ...
    if skill=='speaker-digital-transport-baseline':
    ...
    if skill=='soundbar-crossover-wall-dialogue-baseline':
